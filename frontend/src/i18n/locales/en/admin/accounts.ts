export default {
    accounts: {
      ...
      inputTokenMultiplier: 'Input Token Cost Multiplier',
      outputTokenMultiplier: 'Output Token Cost Multiplier',
      cacheCreationTokenMultiplier: 'Cache Creation Token Cost Multiplier',
      cacheReadTokenMultiplier: 'Cache Read Token Cost Multiplier',
      tokenMultiplierHint: 'Must be greater than 0; only affects actual account cost',
      expiresAt: 'Expires At',
