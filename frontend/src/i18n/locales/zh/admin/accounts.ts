export default {
    accounts: {
      ...
      inputTokenMultiplier: '输入 Token 成本倍率',
      outputTokenMultiplier: '输出 Token 成本倍率',
      cacheCreationTokenMultiplier: '缓存创建 Token 成本倍率',
      cacheReadTokenMultiplier: '缓存读取 Token 成本倍率',
      tokenMultiplierHint: '必须大于 0，仅影响账号实际成本',
      expiresAt: '过期时间',
