export default {
    ...
    groups: {
      ...
      form: {
        ...
        platform: '平台',
        rateMultiplier: '费率倍数',
        inputTokenMultiplier: '输入 Token 折算倍率',
        outputTokenMultiplier: '输出 Token 折算倍率',
        cacheCreationTokenMultiplier: '缓存创建 Token 折算倍率',
        cacheReadTokenMultiplier: '缓存读取 Token 折算倍率',
        hiddenInputRateMultiplier: '输入隐藏成本倍率',
        hiddenOutputRateMultiplier: '输出隐藏成本倍率',
        hiddenCacheCreationRateMultiplier: '缓存创建隐藏成本倍率',
        hiddenCacheReadRateMultiplier: '缓存读取隐藏成本倍率',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
