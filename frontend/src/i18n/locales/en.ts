export default {
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. magaai-backups), choose a region',
    ...
    groups: {
      ...
      form: {
        ...
        cacheCreationTokenMultiplier: 'Cache Create Token Multiplier',
        cacheReadTokenMultiplier: 'Cache Read Token Multiplier',
        hiddenInputRateMultiplier: 'Hidden Input Rate Multiplier',
        hiddenOutputRateMultiplier: 'Hidden Output Rate Multiplier',
        hiddenCacheCreationRateMultiplier: 'Hidden Cache Create Rate Multiplier',
        hiddenCacheReadRateMultiplier: 'Hidden Cache Read Rate Multiplier',
        status: 'Status',
      ...
      tokenMultiplierSectionTitle: 'Token Multipliers',
      tokenMultiplierSectionHint: 'These fields only change the billed token counts and do not directly change the visible rate multiplier.',
      hiddenRateSectionTitle: 'Hidden Rate Multipliers',
      hiddenRateSectionHint: 'These fields are not shown to end users. The frontend still displays the public rate multiplier, but final billing also multiplies the matching hidden rate multiplier.',
    ...
    accounts: {
      ...
      inputTokenRateMultiplier: 'Input Token Multiplier',
      outputTokenRateMultiplier: 'Output Token Multiplier',
      cacheCreationTokenRateMultiplier: 'Cache Create Token Multiplier',
      cacheReadTokenRateMultiplier: 'Cache Read Token Multiplier',
      expiresAt: 'Expires At',
    ...
    settings: {
      ...
      registration: {
        ...
        promoCodeRequiredOnSignup: 'Require Promo Code On Signup',
        promoCodeRequiredOnSignupHint: 'When enabled, users must enter a valid promo code to register and will automatically receive its bonus balance after signup',
      ...
      site: {
        ...
        chatwoot: {
          ...
          description: 'Embed the Chatwoot customer support widget for signed-in users.',
          baseUrl: 'Chatwoot Base URL',
          baseUrlPlaceholder: 'https://support.example.com',
          websiteToken: 'Website Token',
          websiteTokenPlaceholder: 'Paste the Chatwoot website token',
          identityHashSecret: 'Identity Hash Secret',
          identityHashSecretPlaceholder: 'Optional. Used for Chatwoot identity validation',
          identityHashSecretHint: 'Leave empty if Chatwoot identity validation is disabled.',
          identityHashSecretConfigured: 'Identity hash secret is already configured. Enter a new value only if you want to rotate it.',
        },
  ...
  payment: {
    ...
    invoice: {
      ...
      titleName: 'Name',
      titleNamePlaceholder: 'Enter invoice title name',
      taxId: 'Unified Social Credit Code / Tax ID',
      taxIdPlaceholder: 'Enter unified social credit code or tax ID',
      ...
      minimumPayAmount: 'Minimum Invoice Amount',
      orderCount: 'Order Count',
      orderList: 'Orders',
      noEligibleOrders: 'No invoiceable orders',
      noHistory: 'No invoice records yet',
      selectAllVisible: 'Select Visible',
      clearSelection: 'Clear Selection',
      amountThresholdHint: 'Invoice requests require at least {amount} CNY',
      createdOrdersHint: 'Select completed orders that have not been invoiced yet',
      historyHint: 'Review current and historical invoice records',
      goManage: 'Open Invoices',
      viewHistory: 'View History',
      tabs: {
        create: 'Order Invoicing',
        history: 'Invoice History',
      },
      requestedHint: 'The admin is processing this invoice request. Download will be available once the invoice is issued.',
      issuedHint: 'The invoice file is ready. You can download it now.',
      admin: {
        allStatuses: 'All Invoice Statuses',
        searchPlaceholder: 'Search order no., user, name, or tax ID...',
        orderColumn: 'Order',
        detailTitle: 'Invoice Detail',
        orderInfo: 'Order Info',
        issue: 'Upload Invoice',
        issueTitle: 'Upload Invoice',
        issueHint: 'Please upload a PDF invoice file.',
        issueSuccess: 'Invoice uploaded',
        markFailed: 'Mark Failed',
        failTitle: 'Mark Invoice as Failed',
        failPlaceholder: 'Enter the reason that the user will see.',
        failSuccess: 'Invoice marked as failed',
      },
    },
    ...
    errors: {
      ...
      REFUND_FAILED: 'Refund failed.',
      INVOICE_ALREADY_EXISTS: 'An invoice request already exists for this order.',
      INVOICE_ORDERS_EMPTY: 'Please select the orders to invoice.',
      INVALID_ORDER_SELECTION: 'Selected orders must belong to the current user, be completed, and remain uninvoiced.',
      INVOICE_AMOUNT_TOO_LOW: 'The selected invoice amount is below 100 CNY.',
      INVALID_TITLE_NAME: 'Invoice title is invalid.',
      INVALID_TAX_ID: 'Tax ID format is invalid.',
      INVALID_FILE: 'Please upload an invoice file.',
      INVALID_FILE_TYPE: 'Only PDF invoices are supported.',
      FILE_TOO_LARGE: 'Invoice file is too large.',
      INVALID_REASON: 'Failure reason is required.',
      INVOICE_NOT_READY: 'Invoice is not ready for download.',
      FILE_NOT_FOUND: 'Invoice file was not found.',
    },
