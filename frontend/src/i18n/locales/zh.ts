export default {
  ...
  auth: {
    ...
    promoCodePlaceholderRequired: '输入优惠码',
    promoCodeRequired: '请输入优惠码',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 magaai-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    groups: {
      ...
      form: {
        ...
        cacheCreationTokenMultiplier: '缓存写入 Token 倍率',
        cacheReadTokenMultiplier: '缓存命中 Token 倍率',
        hiddenInputRateMultiplier: '隐藏输入 Token 费率倍数',
        hiddenOutputRateMultiplier: '隐藏输出 Token 费率倍数',
        hiddenCacheCreationRateMultiplier: '隐藏缓存写入 Token 费率倍数',
        hiddenCacheReadRateMultiplier: '隐藏缓存命中 Token 费率倍数',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
      ...
      tokenMultiplierSectionTitle: 'Token 倍率',
      tokenMultiplierSectionHint: '这几项只影响记账 Token 数，不直接改变展示给前台的费率倍数。',
      hiddenRateSectionTitle: '隐藏费率倍数',
      hiddenRateSectionHint: '这几项不会显示给前台，前台显示的仍然是费率倍数，但最终金额会额外乘上对应的隐藏费率倍数。',
      noGroupsYet: '暂无分组',
    ...
    accounts: {
      ...
      inputTokenRateMultiplier: '输入 Token 倍率',
      outputTokenRateMultiplier: '输出 Token 倍率',
      cacheCreationTokenRateMultiplier: '缓存写入 Token 倍率',
      cacheReadTokenRateMultiplier: '缓存命中 Token 倍率',
      expiresAt: '过期时间',
    ...
    settings: {
      ...
      registration: {
        ...
        promoCodeRequiredOnSignup: '优惠码必填注册',
        promoCodeRequiredOnSignupHint: '开启后，用户注册时必须填写有效优惠码，注册成功后自动获得对应赠送余额',
      ...
      site: {
        ...
        chatwoot: {
          title: 'Chatwoot 客服',
          description: '为已登录用户嵌入 Chatwoot 客服组件。',
          baseUrl: 'Chatwoot 地址',
          baseUrlPlaceholder: 'https://support.example.com',
          websiteToken: '网站 Token',
          websiteTokenPlaceholder: '请输入 Chatwoot 网站 Token',
          identityHashSecret: '身份校验密钥',
          identityHashSecretPlaceholder: '可选，用于 Chatwoot 身份校验',
          identityHashSecretHint: '如果未启用 Chatwoot identity validation，可以留空。',
          identityHashSecretConfigured: '当前已配置身份校验密钥，如需轮换请重新输入新值。',
        },
        docUrl: '文档链接',
  ...
  payment: {
    ...
    invoice: {
      ...
      download: '下载发票',
      titleName: '名称',
      titleNamePlaceholder: '请输入抬头名称',
      taxId: '统一社会信用代码/纳税人识别号',
      taxIdPlaceholder: '请输入统一社会信用代码或纳税人识别号',
      statusLabel: '开票状态',
      requestedAt: '申请时间',
      issuedAt: '开票时间',
      fileName: '发票文件',
      ...
      selectedAmount: '已选开票金额',
      selectedOrders: '已选订单',
      minimumPayAmount: '最低开票金额',
      orderCount: '订单数',
      orderList: '订单列表',
      noEligibleOrders: '暂无可开票订单',
      noHistory: '暂无开票记录',
      selectAllVisible: '本页全选',
      clearSelection: '清空选择',
      amountThresholdHint: '开票总金额需满 {amount} 元',
      createdOrdersHint: '请选择已完成且未开票的订单',
      historyHint: '查看历史开票记录与当前开票进度',
      goManage: '前往发票管理',
      viewHistory: '查看开票历史',
      tabs: {
        create: '订单开票',
      ...
      requestedHint: '管理员正在处理开票申请，开票完成后可直接下载发票。',
      issuedHint: '发票已上传完成，您现在可以下载发票。',
      admin: {
        allStatuses: '全部开票状态',
        searchPlaceholder: '搜索订单号、用户、名称或税号...',
        orderColumn: '订单',
        detailTitle: '发票详情',
        orderInfo: '订单信息',
        issue: '上传发票',
        issueTitle: '上传发票',
        issueHint: '请上传 PDF 格式的发票文件。',
        issueSuccess: '发票已上传',
        markFailed: '标记失败',
        failTitle: '标记开票失败',
        failPlaceholder: '请输入失败原因，用户点击后即可看到。',
        failSuccess: '已标记为开票失败',
      },
    },
    ...
    errors: {
      ...
      REFUND_FAILED: '退款失败',
      INVOICE_ALREADY_EXISTS: '该订单已提交过开票申请',
      INVOICE_ORDERS_EMPTY: '请选择要开票的订单',
      INVALID_ORDER_SELECTION: '所选订单必须属于当前用户、已完成且未开票',
      INVOICE_AMOUNT_TOO_LOW: '开票总金额未满 100 元，暂不可申请开票',
      INVALID_TITLE_NAME: '开票名称无效',
      INVALID_TAX_ID: '税号格式无效',
      INVALID_FILE: '请上传发票文件',
      INVALID_FILE_TYPE: '仅支持上传 PDF 发票',
      FILE_TOO_LARGE: '发票文件过大',
      INVALID_REASON: '请填写失败原因',
      INVOICE_NOT_READY: '发票尚未开具完成',
      FILE_NOT_FOUND: '发票文件不存在',
    },
