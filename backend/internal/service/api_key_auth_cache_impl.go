...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			HiddenInputRateMultiplier:       apiKey.Group.HiddenInputRateMultiplier,
			HiddenOutputRateMultiplier:      apiKey.Group.HiddenOutputRateMultiplier,
			HiddenCacheCreationRateMultiplier: apiKey.Group.HiddenCacheCreationRateMultiplier,
			HiddenCacheReadRateMultiplier:   apiKey.Group.HiddenCacheReadRateMultiplier,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			HiddenInputRateMultiplier:       snapshot.Group.HiddenInputRateMultiplier,
			HiddenOutputRateMultiplier:      snapshot.Group.HiddenOutputRateMultiplier,
			HiddenCacheCreationRateMultiplier: snapshot.Group.HiddenCacheCreationRateMultiplier,
			HiddenCacheReadRateMultiplier:   snapshot.Group.HiddenCacheReadRateMultiplier,
