...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		HiddenInputRateMultiplier:       g.HiddenInputRateMultiplier,
		HiddenOutputRateMultiplier:      g.HiddenOutputRateMultiplier,
		HiddenCacheCreationRateMultiplier: g.HiddenCacheCreationRateMultiplier,
		HiddenCacheReadRateMultiplier:   g.HiddenCacheReadRateMultiplier,
