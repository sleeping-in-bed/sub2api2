...
func GroupFromServiceAdmin(g *service.Group) *AdminGroup {
	...
	out := &AdminGroup{
		...
		HiddenInputRateMultiplier:         g.HiddenInputRateMultiplierOrDefault(),
		HiddenOutputRateMultiplier:        g.HiddenOutputRateMultiplierOrDefault(),
		HiddenCacheCreationRateMultiplier: g.HiddenCacheCreationRateMultiplierOrDefault(),
		HiddenCacheReadRateMultiplier:     g.HiddenCacheReadRateMultiplierOrDefault(),
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		InputTokenMultiplier:            g.InputTokenMultiplierOrDefault(),
		OutputTokenMultiplier:           g.OutputTokenMultiplierOrDefault(),
		CacheCreationTokenMultiplier:    g.CacheCreationTokenMultiplierOrDefault(),
		CacheReadTokenMultiplier:        g.CacheReadTokenMultiplierOrDefault(),
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		InputTokenMultiplier:    a.InputTokenMultiplier(),
		OutputTokenMultiplier:   a.OutputTokenMultiplier(),
		CacheCreationTokenMultiplier: a.CacheCreationTokenMultiplier(),
		CacheReadTokenMultiplier: a.CacheReadTokenMultiplier(),
		Status:                  a.Status,
